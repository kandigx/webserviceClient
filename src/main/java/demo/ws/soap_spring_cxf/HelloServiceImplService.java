 ...
 * 
 */
@WebServiceClient(name = "HelloServiceImplService", targetNamespace = "http://soap_spring_cxf.ws.demo/", wsdlLocation = "http://localhost:8080/ws/soap/hello?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/ws/soap/hello?wsdl");
